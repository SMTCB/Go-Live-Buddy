...
async def query_agent_stream(query: str, namespace: str):
    ...
    try:
        ...
        yield f"I'm sorry, I encountered an error searching for that. Please try again."
...
async def analyze_image_stream(messages: list, namespace: str, base64_image: str):
    ...
    try:
        ...
        yield f"I'm sorry, I couldn't synthesize a solution from the provided screenshot."
